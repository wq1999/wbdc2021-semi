...
if __name__ == "__main__":
    ...
    for f1, f2 in tqdm([['userid', 'feedid']]):
        ...
        test = test.merge(emb_df, on=f1, how='left')
    ...
    #     model2 = MMOE(dnn_feature_columns, num_tasks=7, task_types=['binary', 'binary', 'binary', 'binary', 'binary', 'binary', 'binary'],
